...
# Script to encode pregnancy-lens.js to base64 and update pregnancy-lens.json

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_DIR="$(dirname "$SCRIPT_DIR")"

JS_FILE="$PROJECT_DIR/pregnancy-lens.js"
JSON_FILE="$PROJECT_DIR/pregnancy-lens.json"
...
console.log('✅ Updated pregnancy-lens.json with encoded JS');
"
